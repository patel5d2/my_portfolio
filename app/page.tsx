...
export default function HomePage() {
  ...
  const skills = {
    cybersecurity: [
      ...
      { name: "MFA", level: 95 },
      { name: "DLP", level: 75 },
      { name: "Insider Threat Detection", level: 85 },
    ],
    networking: [
        ...
        <div className="max-w-6xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <a href="/blog" className="font-mono text-sm text-green-400 hover:text-green-300 transition-colors underline-anim">
                blog
              </a>
            </nav>
          </div>
                  ...
                  {skills.cybersecurity.map((skill, i) => (
                    <div key={i}>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="font-mono text-sm text-green-300">{skill.level}%</span>
                      </div>
                      <Progress value={skill.level} className="w-full bg-green-900/50 h-2" />
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <CardContent>
              <form className="space-y-4">
                <div className="flex flex-col sm:flex-row gap-4">
                  <Input type="text" placeholder="> Name" className="bg-transparent border-green-400 text-green-400 placeholder:text-green-400" />
                  <Input type="email" placeholder="> Email" className="bg-transparent border-green-400 text-green-400 placeholder:text-green-400" />
                </div>
                <Textarea placeholder="> Message" className="bg-transparent border-green-400 text-green-400 placeholder:text-green-400" />
                <Button type="submit" className="bg-green-600 hover:bg-green-500 text-black font-mono font-bold px-6 py-2 border-2 border-green-400 transition-all duration-200 hover:shadow-lg hover:shadow-green-400/50 hover:scale-105 pixel-shift-hover">
                  &gt; Send Message
                </Button>
              </form>
            </CardContent>
